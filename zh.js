...
var cnItems = {
    ...
    'MAX': '最大',
    'Save': '保存',
    'Show more details (click the cell to flush': '显示更多详细信息(单击单元格进行刷新',
    'Credits': '鸣谢',
    'Upgrade': '升级',
    '10 min of SpeedUP': '10分钟加速',
    'Watch an ad to get free': '观看广告获得免费',
    'Reach INF': '达到无限',
    '': '',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    ...
    [/^Reach a total of (.+) points$/, '累计达到 $1 点数'],
